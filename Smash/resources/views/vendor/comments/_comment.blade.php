...
<div id="comment-{{ $comment->getKey() }}" class="media pt-2">
    <img class="rounded-circle mr-3" src="{{asset('storage'.'/'. $comment->commenter->image ?? $comment->guest_image)}}" width="64px" height="64px" alt="imageProfil">
